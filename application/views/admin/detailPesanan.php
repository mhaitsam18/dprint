                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row" style="width: 70%;">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="lihatUkuran" <?php foreach ($ukuran as $key): ?>
                                                    <?php 
                                                    $sub_pemesanan = $this->db->get_where('sub_pemesanan', ['id_pemesanan' => $ps['id_pesanan'], 'id_ukuran' => $key->id_ukuran])->row();
                                                     ?>
                                                     <?php if ($sub_pemesanan){
                                                        $kuantitas = $sub_pemesanan->kuantitas;
                                                     } else{
                                                        $kuantitas = 0;
                                                     } ?>
                                                    data-<?= strtolower($key->ukuran) ?>="<?= $kuantitas ?>"
                                                <?php endforeach ?>>
                                        Lihat Ukuran
                                    </button>
                                </td>
