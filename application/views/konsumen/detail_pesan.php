                                ...
                                <tbody>
                                    ...
                                    foreach ($detail_pesan as $item) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalUkuran" id="seen_ukuran"
                                                <?php foreach ($ukuran as $key): ?>
                                                    <?php 
                                                    $sub_pemesanan = $this->db->get_where('sub_pemesanan', ['id_pemesanan' => $item['id_pesanan'], 'id_ukuran' => $key->id_ukuran])->row();
                                                     ?>
