            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <form method="post" action="<?= base_url('konsumen/masukKeranjang') ?>" enctype="multipart/form-data">
                            ...
                            <?php foreach ($ukuran as $key): ?>
                                <div class="form-group col-md-4">
                                    <label for="inputEmail4">Ukuran <?= $key->ukuran ?></label>
                                    <input type="number" min="0" class="form-control" id="" name="ukuran[<?= strtolower($key->id_ukuran) ?>]" value="0">
                                </div>
                            <?php endforeach ?>
