...
<main class="ps-main">
    <div class="ps-checkout pt-80 pb-80">
        <div class="ps-container">
            ...
            <form class="ps-checkout__form" action="<?= base_url('konsumen/bayar_barang') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                        ...
                        <div class="ps-checkout__order">
                            ...
                            <footer>
                                ...
                                <div class="form-group paypal">
                                    ...
                                    <?php
                                    $data = [];
                                    foreach ($barang_keranjang_aktif as $item) {
                                    ...
                                    <div class="form-group form-group--inline">
                                        ...
                                        <select class="custom-select mb-2" id="inputGroupSelect01" name="pembayarann" required>
                                            ...
                                            <?php foreach ($jenis_bayar as $item): ?>
